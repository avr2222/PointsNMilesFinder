...
export class HiltonHonors extends BaseSource {
  ...
  async fetchDeals() {
    ...
    return [
      ...
      this.makeHotelDeal({ hotelName: 'Waldorf Astoria Maldives', city: 'Maldives', hotelCategory: '5-star', nights: 5, points: 480000, cashInr: 600000, notes: '5th night free included (Hilton 5th night award benefit). Best Maldives luxury value', transferRatio: 0.5, region: 'asia' }),
